...
import { Loader2, UserPlus, Search, X, Users } from 'lucide-react'
import { useRouter } from 'next/navigation'
import { cn } from "~/lib/utils"
import { Input } from "~/components/ui/input"

export function ViewFriendsDialog({ children }: { children: React.ReactNode }) {
...
const handleViewProfile = ()=>{
    router.push(`/user/${selectedFriend}`)
}
  ...
  return (
    ...
    <span className="sr-only">Close</span>
        ...
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold tracking-tight text-white">View all your Friends</DialogTitle>
        </DialogHeader>
